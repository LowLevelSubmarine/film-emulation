...
== Vorgehensweise
Die Implementierung der Effekte erfolgt in der hohen Programmiersprache Kotlin. Die Bibliothek OpenCV wird verwendet, um die Bildverarbeitung hardware-nah zu realisieren. Die Effekte werden in einer Pipeline nacheinander auf das Bild angewendet. Um die Performance zu verbessern, werden statische Werte, die wiederholt berechnet werden müssten, in einem Cache gespeichert.
== Aufbau
