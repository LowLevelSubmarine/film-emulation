...
Zur Performance-Optimierung wird nur alle 300ms eine Änderung rausgesendet, so dass die Zwischenwerte beim Verschieben des Sliders nicht auch versendet weurden. So können unnötige Neuberechnungen vermieden werden.
