...
#wrap-content(
    ...
    [
      ...
      === Schutzschicht
      Die oberste Schicht ist die Schutzschicht, die das Bild vor Umwelteinflüssen schützt.

      === UV-Filter
      Das menschliche Auge ist nicht in der Lage, ultraviolettes Licht wahrzunehmen. Daher befindet sich unter der Schutzschicht ein UV-Filter, der das ultraviolette Licht herausfiltert, sodass ultraviolettes Licht keinen Einfluss auf die darunter liegenden Emulsionsschichten haben kann.

      === Gelbe Emulsionsschichten
      Die erste Emulsionsschicht ist für die Aufnahme von blauem Licht zuständig. Sie wird als Gelb bezeichnet, da sie während der Entwicklung gelben Farbstoff freisetzt. Die Emulsionsschichten können je nach Film unterschiedlich aufgebaut sein. Es gibt Filme mit bis zu drei verschiedenen Empfindlichkeiten, welche dann als "Low speed-", "Medium speed-" und "High speed layers" bezeichnet werden. Diese erhöhen den Dynamikumfang des aufgenommenen Bildes. @multiple-emulsion-layers-per-color

      === Gelbfilter
      Um die Farben des Bildes möglichst korrekt darzustellen, wird unter der gelben Emulsionsschicht ein Gelbfilter eingesetzt, um verbleibendes blaues Licht herauszufiltern, sodass weitere Emulsionsschichten nicht durch blaues Licht belichtet werden können.
      ...
      === Rotfilter
      Analog zum Gelbfilter wird unter der magenta Emulsionsschicht ein Rotfilter eingesetzt, um verbleibendes grünes Licht herauszufiltern.
      ...
      === Anti-Halationsschicht
      Die unterste Schicht vor dem Schichtträger ist die Anti-Halationsschicht. Ohne diese Schicht könnte Licht von der Rückseite des Films oder der Kamera reflektiert werden und so die Emulsionsschichten ungehindert erneut belichten.

      === Schichtträger
      Der Schichtträger ist das Trägermaterial, auf dem die Emulsionsschichten aufgebracht sind. Er sorgt für die Stabilität des Films und schützt die Emulsionsschichten vor Umwelteinflüssen. @film-structure
    ],
    align: right,
)
