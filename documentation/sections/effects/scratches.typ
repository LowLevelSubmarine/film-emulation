...
=== Theorie
Kratzer auf dem Film führen zu hellen oder dunklen Artefakten im Bild. 
Die Form und Intensität dieser Artefakte hängen von der Ursache und der Art des Films ab.

=== Implementierung
Um Kratzer auf digitalen Bildern zu emulieren, wird die Funktion `scratches` verwendet.
