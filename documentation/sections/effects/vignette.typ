...
=== Implementierung
Um den klassischen Analog-Film-Look zu verbessern, wird ein Vignetteneffekt hinzugefügt. Dieser Effekt dunkelt die Bildränder ab. Der Vignetteneffekt wird durch die Funktion `vignette(image: Mat, config: Config)` implementiert.
